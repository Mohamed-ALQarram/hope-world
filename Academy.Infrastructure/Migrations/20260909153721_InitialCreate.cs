    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClassProgressId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    SubjectId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassProgresses", x => x.ClassProgressId);
                    table.ForeignKey(
                        name: "FK_ClassProgresses_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassProgresses_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Instructors_InstructorId_SubjectId", x => new { x.InstructorId, x.SubjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTutorialId = table.Column<int>(type: "int", nullable: true),
                    CurrentQuizId = table.Column<int>(type: "int", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teaches_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teaches_Instructors_InstructorId_SubjectId",
                        columns: x => new { x.InstructorId, x.SubjectId },
                        principalTable: "Instructors",
                        principalColumns: new[] { "InstructorId", "SubjectId" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tutorials_Levels_LevelId",
                        column: x => x.LevelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_Tutorials_TutorialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChooseQuestions", x => x.QuestionId);
                    table.ForeignKey(
                        name: "FK_ChooseQuestions_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompleteQuestions", x => x.QuestionId);
                    table.ForeignKey(
                        name: "FK_CompleteQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectMatches = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DragDropQuestions", x => x.QuestionId);
                    table.ForeignKey(
                        name: "FK_DragDropQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchingQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizAttemptId = table.Column<int>(type: "int", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    AnswerData = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassProgresses_ClassId_SubjectId",
                table: "ClassProgresses",
                columns: new[] { "ClassId", "SubjectId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClassProgresses_SubjectId",
                table: "ClassProgresses",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Instructors_InstructorId_SubjectId",
                table: "Instructors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quizzes_TutorialId",
                table: "Quizzes",
                column: "TutorialId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentProgresses_StudentId_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teaches_ClassId_SubjectId",
                table: "Teaches",
                columns: new[] { "ClassId", "SubjectId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Teaches_InstructorId_SubjectId",
                table: "Teaches",
                columns: new[] { "InstructorId", "SubjectId" });
